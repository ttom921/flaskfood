...
def LOG_LEVEL_DEBUG():
    coloredlogs.install(level='DEBUG', fmt='%(asctime)s.%(msecs)03d [%(thread)d] [%(filename)s:%(lineno)s] %(levelname)-7s %(message)s ')


def LOG_LEVEL_INFO():
    coloredlogs.install(level='INFO', fmt='%(asctime)s.%(msecs)03d [%(thread)d] [%(filename)s:%(lineno)s] %(levelname)-7s %(message)s ')


def LOG_LEVEL_ERROR():
    coloredlogs.install(level='ERROR', fmt='%(asctime)s.%(msecs)03d [%(thread)d] [%(filename)s:%(lineno)s] %(levelname)-7s %(message)s ')
